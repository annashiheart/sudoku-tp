...
def playScreen_onScreenStart(app):
    ...
    app.buttonWidth = 150
    app.buttonHeight = 50
    playScreen_appStarted(app)

def playScreen_appStarted(app):
